...
func TestDoSelect1(t *testing.T) {
	...
	net := gofbp.NewNetwork("DoSelect1")
...
func TestDoSelect2(t *testing.T) {
	...
	net := gofbp.NewNetwork("DoSelect2")
...
func TestWriteToConsUsingNL(t *testing.T) {
	...
	net := gofbp.NewNetwork("TestWriteToConsUsingNL")
