...
For information about how to use the `GoFBP` Websockets components, see https://jpaulm.github.io/fbp/gofbp_websockets.html .  In this test case, we use HTML and JavaScript as the client. 
